...
const menuLabelKeys: Record<MenuKey, TranslationKey> = {
  ...
  skills: "nav.skills",
  promptPlugins: "nav.promptPlugins",
...
export function AdminShell({
  ...
  const menuItems = useMemo<MenuProps["items"]>(() => {
    ...
    const items = [
      ...
      { key: "skills" as const, icon: <PackageOpen size={17} />, label: t("nav.skills") },
      { key: "promptPlugins" as const, icon: <Sparkles size={17} />, label: t("nav.promptPlugins") },

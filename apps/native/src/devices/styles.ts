...
export const styles = StyleSheet.create({
  ...
  heading: { flex: 1, color: deviceColors.ink, fontSize: 30, fontWeight: '800' },
  subtitle: { color: deviceColors.muted, fontSize: 13, lineHeight: 20, marginTop: 5, marginBottom: 18 },
  refresh: {
  ...
  statValue: { color: deviceColors.ink, fontSize: 28, fontWeight: '800' },
  statLabelRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 3 },
  statLabel: { color: deviceColors.muted, fontSize: 12 },
  listTitle: { color: deviceColors.ink, fontSize: 17, fontWeight: '700', marginBottom: 14 },
  ...
  name: { color: deviceColors.ink, fontSize: 16, fontWeight: '800' },
  meta: { color: deviceColors.muted, fontSize: 12, marginTop: 5 },
  badge: {
  ...
  badgeText: { color: deviceColors.green, fontSize: 12, fontWeight: '700' },
  ...
  detailLabel: { color: deviceColors.muted, fontSize: 12, width: 72 },
  detailValue: { flex: 1, minWidth: 0, color: deviceColors.ink, fontSize: 12, lineHeight: 18, textAlign: 'right' },
  hint: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 12,
    backgroundColor: '#e4f6ef', borderRadius: 14, padding: 15,
  },
  hintText: { flexShrink: 1, color: deviceColors.muted, fontSize: 12, lineHeight: 19 },
  empty: { alignItems: 'center', padding: 32, borderRadius: 18, backgroundColor: '#fff', gap: 12 },
  emptyTitle: { color: deviceColors.ink, fontSize: 17, fontWeight: '700' },
  emptyText: { color: deviceColors.muted, fontSize: 13, lineHeight: 21, textAlign: 'center' },
  overlay: {
  ...
  menuTitle: { flex: 1, color: deviceColors.ink, fontSize: 18, fontWeight: '700' },
  close: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  option: { flexDirection: 'row', alignItems: 'center', minHeight: 52, padding: 10, gap: 12, borderRadius: 12 },
  optionLabel: { flex: 1, color: deviceColors.ink, fontSize: 16 },

export enum Permission {
  ChatSettingsRead = 'admin.chat-settings.read',
  ChatSettingsManage = 'admin.chat-settings.manage',
  ...
  OfficialAccountsReadOwn = 'admin.official-accounts.read-own',
  OfficialAccountsRead = 'admin.official-accounts.read',
  OfficialAccountsManageOwn = 'admin.official-accounts.manage-own',
...
export const PERMISSION_CATALOG: readonly PermissionDefinition[] = [
  ...
  { code: Permission.OfficialAccountsReadOwn, group: 'official-accounts', name: 'Read own official accounts', description: 'View only official pool accounts added by the current user.' },
  ...
  { code: Permission.OfficialAccountsManageOwn, group: 'official-accounts', name: 'Manage own official accounts', description: 'Create pool accounts and manage only accounts added by the current user.' },
...
const PERMISSION_DEPENDENCIES: Partial<Record<Permission, readonly Permission[]>> = {
  ...
  [Permission.OfficialAccountsManageOwn]: [Permission.OfficialAccountsReadOwn, Permission.UsersRead],

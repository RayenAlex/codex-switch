import type { Skill, SkillsResponse } from '../remote-chat/client/types';
import { normalizeSkills } from '../remote-chat/skills';
export { normalizeSkills, skillLabel, skillDescription } from '../remote-chat/skills';
